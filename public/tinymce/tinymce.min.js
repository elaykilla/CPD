...
!function(e, t) {
    ...
    r(l, [], function() {
                                ...
                                if (r)
                                    for (u = o.length; u--; )
                                        if (o[u].func === r) {
                                            ...
                                            o = o.slice(0, u).concat(o.slice(u + 1)), o.nativeHandler = p, f[d] = o, o.splice(u, 1)
                                        }
        ...
        function C(e, t, n, r) {
            var i, o, a, s, l, c = d(e);
            if (!r && 1 === c.length) {
                if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && L && N.relative[o[1].type]) {
            ...
            return S(e, c)(r, t, !L, n, mt.test(e)), n
        }
        function x() {
        }
        var w, _, N, E, k, S, T, R, A, B, D, H, L, M, P, O, I, F = "sizzle" + -new Date, W = window.document, z = {}, V = 0, U = 0, q = n(), j = n(), $ = n(), K = !1, G = function() {
            return 0
        ...
        k = a.isXML = function(e) {
            ...
            return r !== D && 9 === r.nodeType && r.documentElement ? (D = r, H = r.documentElement, L = !k(r), z.getElementsByTagName = o(function(e) {
                ...
                e.id = F + 0, e.appendChild(D.createElement("a")).setAttribute("name", F), e.appendChild(D.createElement("i")).setAttribute("name", F), H.appendChild(e);
                var t = r.getElementsByName && r.getElementsByName(F).length === 2 + r.getElementsByName(F + 0).length;
                return H.removeChild(e), t
            ...
            }, P = [], M = [":focus"], (z.qsa = e(r.querySelectorAll)) && (o(function(e) {
                e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || M.push("\\[" + rt + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"), e.querySelectorAll(":checked").length || M.push(":checked")
            }), o(function(e) {
                e.innerHTML = "<input type='hidden' i=''/>", e.querySelectorAll("[i^='']").length && M.push("[*^$]=" + rt + "*(?:\"\"|'')"), e.querySelectorAll(":enabled").length || M.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), M.push(",.*:")
            })), (z.matchesSelector = e(O = H.matchesSelector || H.mozMatchesSelector || H.webkitMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && o(function(e) {
                z.disconnectedMatch = O.call(e, "div"), O.call(e, "[s!='']:x"), P.push("!=", lt)
            }), M = new RegExp(M.join("|")), P = P.length && new RegExp(P.join("|")), I = e(H.contains) || H.compareDocumentPosition ? function(e, t) {
            ...
            if ((e.ownerDocument || e) !== D && B(e), t = t.replace(xt, "='$1']"), z.matchesSelector && L && (!P || !P.test(t)) && !M.test(t))
                try {
                    var n = O.call(e, t);
            ...
            var n;
            return(e.ownerDocument || e) !== D && B(e), L && (t = t.toLowerCase()), (n = N.attrHandle[t]) ? n(e) : !L || z.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
        }, a.error = function(e) {
        ...
        function t(n) {
            ...
            function E(e) {
                ...
                if (e != I && (t = r()), L[z] == L[q])
                    return t;
                if (3 == L[V].nodeType) {
                    if (n = L[V].nodeValue, i = n.substring(L[z], L[q]), e != O && (o = L[V], c = L[z], u = L[q] - L[z], 0 === c && u >= o.nodeValue.length - 1 ? o.parentNode.removeChild(o) : o.deleteData(c, u), L.collapse(F)), e == I)
                        return;
            ...
            var L = this, M = n.doc, P = 0, O = 1, I = 2, F = !0, W = !1, z = "startOffset", V = "startContainer", U = "endContainer", q = "endOffset", j = e.extend, $ = n.nodeIndex;
            return j(L, {startContainer: M, startOffset: 0, endContainer: M, endOffset: 0, collapsed: F, commonAncestorContainer: M, START_TO_START: 0, START_TO_END: 1, END_TO_END: 2, END_TO_START: 3, setStart: i, setEnd: o, setStartBefore: a, setStartAfter: s, setEndBefore: l, setEndAfter: c, collapse: u, selectNode: d, selectNodeContents: f, compareBoundaryPoints: p, deleteContents: h, extractContents: m, cloneContents: g, insertNode: v, surroundContents: y, cloneRange: b, toStringIE: H}), L
        }
        ...
        return c.prototype = {root: null, props: {"for": "htmlFor", "class": "className", className: "className", checked: "checked", disabled: "disabled", maxlength: "maxLength", readonly: "readOnly", selected: "selected", value: "value", id: "id", name: "name", type: "type"}, fixDoc: function(e) {
                ...
                var e = this;
                if (e.boundEvents) {
                    for (var t = e.boundEvents.length; t--; ) {
                        var n = e.boundEvents[t];
                        this.events.unbind(n[0], n[1], n[2])
                    }
                    e.boundEvents = null
                }
        ...
        return r.prototype = {get: function(e) {
                ...
                r.language && r.languageLoad !== !1 && e.ScriptLoader.add(this.urls[t] + "/langs/" + r.language + ".js")
            }, add: function(e, t, n) {
        ...
        return function(n, i) {
            ...
            n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var a = this, s, l = 0, c, u, d = [], f, p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, D, H, L, M, P, O = 0, I = t.decode, F;
                for (H = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), L = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, y = i.getShortEndedElements(), D = n.self_closing_elements || i.getSelfClosingElements(), b = i.getBoolAttrs(), x = n.validate, v = n.remove_internals, F = n.fix_self_closing, M = i.getSpecialElements(); s = H.exec(e); ) {
                    if (l < s.index && a.text(I(e.substr(l, s.index - l))), c = s[6])
                        ...
                        if (c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), C = c in y, F && D[c] && d.length > 0 && d[d.length - 1].name === c && r(c), !x || (w = i.getElementRule(c))) {
                            ...
                            _ = !1;
                        if (u = M[c]) {
                            u.lastIndex = l = s.index + s[0].length, (s = u.exec(e)) ? (_ && (h = e.substr(l, s.index - l)), l = s.index + s[0].length) : (h = e.substr(l), l = e.length), _ && (h.length > 0 && a.text(h, !0), a.end(c)), H.lastIndex = l;
                            continue
                        }
        ...
        return function(r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function(e) {
                ...
                var v, y, b, C, x, w, _, N, E, k, S, T, R, A = [], B, D, H, L, M, P, O, I;
                if (o = o || {}, p = {}, h = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, M = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, H = /[ \t\r\n]+/g, L = /^[ \t\r\n]+$/, v = new n({validate: S, self_closing_elements: g(l.getSelfClosingElements()), cdata: function(e) {
                        ...
                        var n;
                        B || (e = e.replace(H, " "), b.lastChild && T[b.lastChild.name] && (e = e.replace(R, ""))), 0 !== e.length && (n = u("#text", 3), n.raw = !!t, b.append(n).value = e)
                    }, comment: function(e) {
        ...
        return function(r, i) {
            ...
            function s() {
                ...
                H = !1, e("width", L), e("height", M), b.unbind(P, "mousemove", a), b.unbind(P, "mouseup", s), O != P && (b.unbind(O, "mousemove", a), b.unbind(O, "mouseup", s)), b.remove(w), I && "TABLE" != x.nodeName || l(x), i.fire("ObjectResized", {target: x, width: L, height: M}), i.nodeChanged()
            }
            function l(e, t, n) {
                var r, l, u, d, f, p = i.getBody().offsetParent || i.getBody();
                r = b.getPos(e, p), T = r.x, R = r.y, f = e.getBoundingClientRect(), l = f.width || f.right - f.left, u = f.height || f.bottom - f.top, x != e && (m(), x = e, L = M = 0), d = i.fire("ObjectSelected", {target: e}), o(e) && !d.isDefaultPrevented() ? C(_, function(e, r) {
                    function o(t) {
                        H = !0, k = t.screenX, S = t.screenY, A = x.clientWidth, B = x.clientHeight, D = B / A, N = e, w = x.cloneNode(!0), b.addClass(w, "mce-clonedresizable"), w.contentEditable = !1, w.unSelectabe = !0, b.setStyles(w, {left: T, top: R, margin: 0}), w.removeAttribute("data-mce-selected"), i.getBody().appendChild(w), b.bind(P, "mousemove", a), b.bind(P, "mouseup", s), O != P && (b.bind(O, "mousemove", a), b.bind(O, "mouseup", s))
                    }
                    var c, d;
            ...
            var b = i.dom, C = t.each, x, w, _, N, E, k, S, T, R, A, B, D, H, L, M, P = i.getDoc(), O = document, I = n.ie && n.ie < 11;
        ...
        return a.prototype = {setCursorLocation: function(e, t) {
                ...
                function r(t, n) {
                    ...
                    do {
                        ...
                        if (l[t.nodeName])
                            return n ? a.setStartBefore(t) : "BR" == t.nodeName ? a.setEndBefore(t) : a.setEndAfter(t), void 0
                    } while (t = n ? i.next() : i.prev());
                    "BODY" == r.nodeName && (n ? a.setStart(r, 0) : a.setEnd(r, r.childNodes.length))
                }
                var i = this, o = i.dom, a = o.createRng(), s, l;
                if (i.lastFocusBookmark = null, l = o.schema.getNonEmptyElements(), t) {
                ...
                if ("BODY" != a.nodeName) {
                    ...
                    if (c)
                        return n = t(e).y - t(c).y, l = c.clientHeight, s = c.scrollTop, (s > n || n + 25 > s + l) && (c.scrollTop = s > n ? n : n - l + 25), void 0
                }
        ...
        return function(r) {
                ...
                function d(e, r, o) {
                    ...
                    c = m.inline || m.block, d = I.create(c), s(d), W.walk(e, function(e) {
                        ...
                        if (m.inline || m.wrapper) {
                            ...
                            }), e && m.merge_siblings !== !1 && (e = H(B(e), e), e = H(e, B(e, G)))
                        }
                    })
                }
            ...
            function h(e, t, n) {
                ...
                return n ? (n.nodeType ? (y = I.createRng(), y.setStartBefore(n), y.setEndAfter(n), f(y)) : f(n), void 0) : (F.isCollapsed() && h.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length ? M("remove", e, t) : (m = F.getBookmark(), f(F.getRng(G)), F.moveToBookmark(m), h.inline && v(e, t, F.getStart()) && P(F.getRng(!0)), r.nodeChanged()), void 0)
            }
            function m(e, t, n) {
                var r = c(e);
        ...
        return function(t) {
            function r(r) {
                ...
                function v() {
                    function e(e) {
                        for (var t = H[e ? "firstChild" : "lastChild"]; t && 1 != t.nodeType; )
                            t = t[e ? "nextSibling" : "previousSibling"];
                        return t === T
                    }
                    function t() {
                        var e = H.parentNode;
                        return"LI" == e.nodeName ? e : H
                    }
                    var n = H.parentNode.nodeName;
                    /^(OL|UL|LI)$/.test(n) && (P = "LI"), B = P ? h(P) : i.create("BR"), e(!0) && e() ? "LI" == n ? i.insertAfter(B, t()) : i.replace(B, H) : e(!0) ? "LI" == n ? (i.insertAfter(B, t()), B.appendChild(i.doc.createTextNode(" ")), B.appendChild(H)) : H.parentNode.insertBefore(B, H) : e() ? (i.insertAfter(B, t()), d(B)) : (H = t(), N = _.cloneRange(), N.setStartAfter(T), N.setEndAfter(H), D = N.extractContents(), i.insertAfter(D, H), i.insertAfter(B, H)), i.remove(T), p(B), s.add()
                }
                function y() {
                ...
                var _ = o.getRng(!0), N, E, k, S, T, R, A, B, D, H, L, M, P, O;
                if (!_.collapsed)
                ...
                if (!r.isDefaultPrevented() && (k = _.startContainer, S = _.startOffset, P = (a.force_p_newlines ? "p" : "") || a.forced_root_block, P = P ? P.toUpperCase() : "", R = i.doc.documentMode, A = r.shiftKey, 1 == k.nodeType && k.hasChildNodes() && (O = S > k.childNodes.length - 1, k = k.childNodes[Math.min(S, k.childNodes.length - 1)] || k, S = O && 3 == k.nodeType ? k.nodeValue.length : 0), E = x(k))) {
                    if (s.beforeChange(), !i.isBlock(E) && E != i.getRoot())
                        return(!P || A) && b(), void 0;
                    if ((P && !A || !P && A) && (k = g(k, S)), T = i.getParent(k, i.isBlock), H = T ? i.getParent(T.parentNode, i.isBlock) : null, L = T ? T.nodeName.toUpperCase() : "", M = H ? H.nodeName.toUpperCase() : "", "LI" != M || r.ctrlKey || (T = H, L = M), "LI" == L) {
                        if (!P && A)
                            return b(), void 0;
                        if (i.isEmpty(T))
                            return v(), void 0
        ...
        return function(n) {
            ...
            o(this, {execCommand: r, queryCommandState: p, queryCommandValue: h, addCommands: m}), m({"mceResetDesignMode,mceBeginUndoLevel": function() {
                    ...
                    /^ | $/.test(i) && (i = o(i)), a = n.parser, s = new e({}, n.schema), b = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', f = {content: i, format: "html", selection: !0}, n.fire("BeforeSetContent", f), i = f.content, -1 == i.indexOf("{$caret}") && (i += "{$caret}"), i = i.replace(/\{\$caret\}/, b), w.isCollapsed() || n.getDoc().execCommand("Delete", !1, null), l = w.getNode();
                    var _ = {context: l.nodeName.toLowerCase()};
                    if (d = a.parse(i, _), v = d.lastChild, "mce_marker" == v.attr("id"))
        ...
        return window.elementIdCache = o, l
    }), r(U, [], function() {
        var e = {}, t;
        ...
        var o = e.extend({modal: !0, Defaults: {border: 1, layout: "flex", containerCls: "panel", role: "dialog", callbacks: {submit: function() {
                ...
                var e = this;
                e.dragHelper.destroy(), e._super(), e.statusbar && this.statusbar.remove()
            }});
        return o
    }), r(Z, [Q], function(e) {
        ...
        return function(n) {
            ...
            i.windows = o, i.open = function(t, r) {
                var i;
                return n.editorManager.activeEditor = n, t.title = t.title || " ", t.url = t.url || t.file, t.url && (t.width = parseInt(t.width || 320, 10), t.height = parseInt(t.height || 240, 10)), t.body && (t.items = {defaults: t.defaults, type: t.bodyType || "form", items: t.body}), t.url || t.buttons || (t.buttons = [{text: "Ok", subtype: "primary", onclick: function() {
        ...
        return function(a) {
            ...
            function u() {
                function t(e) {
                    ...
                    if (n.collapsed || (e = !0), l = n[(e ? "start" : "end") + "Container"], c = n[(e ? "start" : "end") + "Offset"], 3 == l.nodeType && (r = W.getParent(n.startContainer, W.isBlock), e && (r = W.getNext(r, W.isBlock)), !r || !t() && n.collapsed || (i = W.create("em", {id: "__mceDel"}), O(o.grep(r.childNodes), function(e) {
                        i.appendChild(e)
                    }), r.appendChild(i))), n = W.createRng(), n.setStart(d[0], d[1]), n.setEnd(d[2], d[3]), z.setRng(n), a.getDoc().execCommand(e ? "ForwardDelete" : "Delete", !1, null), i) {
                        for (s = z.getBookmark(); u = W.get("__mceDel"); )
                            W.remove(u, !0);
                        z.moveToBookmark(s)
                    }
                }
                a.on("keydown", function(n) {
                    var r;
                    r = n.keyCode == F, c(n) || !r && n.keyCode != I || e.modifierPressed(n) || (n.preventDefault(), t(r))
            ...
            function d() {
                function e(e) {
                    ...
                    return t.appendChild(n), z.serializer.serialize(t, {format: "html"})
                }
                function t(t) {
                    var n = e(t), r = W.createRng();
                ...
                a.on("keydown", function(e) {
                    var n = e.keyCode, r;
                    if (!c(e) && (n == F || n == I)) {
                        if (r = a.selection.isCollapsed(), r && !W.isEmpty(a.getBody()))
                            return;
                        if ($ && !r)
                            return;
            ...
            function p() {
                a.settings.content_editable || (W.bind(a.getDoc(), "focusin", function() {
                    ...
                    e.target == a.getDoc().documentElement && (a.getWin().focus(), z.setRng(z.getRng()))
                }))
            }
            function h() {
                a.on("keydown", function(e) {
                    if (!c(e) && e.keyCode === I && z.isCollapsed() && 0 === z.getRng(!0).startOffset) {
                        var t = z.getNode(), n = t.previousSibling;
                        if ("HR" == t.nodeName)
                            return W.remove(t), e.preventDefault(), void 0;
            ...
            function g() {
                a.on("click", function(e) {
                    e = e.target, /^(IMG|HR)$/.test(e.nodeName) && z.getSel().setBaseAndExtent(e, 0, e, 1), "A" == e.nodeName && W.hasClass(e, "mce-item-anchor") && z.select(e), a.nodeChanged()
                })
            }
            function v() {
                function e() {
                    var e = W.getAttribs(z.getStart().cloneNode(!1));
                    return function() {
                        var t = z.getStart();
                        t !== a.getBody() && (W.setAttrib(t, "style", null), O(e, function(e) {
                            t.setAttributeNode(e.cloneNode(!0))
                        }))
                    }
                }
                function t() {
                    return!z.isCollapsed() && W.getParent(z.getStart(), W.isBlock) != W.getParent(z.getEnd(), W.isBlock)
                }
            ...
            function C() {
                a.on("keydown", function(e) {
                    if (!c(e) && e.keyCode === I && z.isCollapsed() && 0 === z.getRng(!0).startOffset) {
                        var t = z.getNode().previousSibling;
            ...
            function x() {
                l() > 7 || (s("RespectVisibilityInDesign", !0), a.contentStyles.push(".mceHideBrInPre pre br {display: none}"), W.addClass(a.getBody(), "mceHideBrInPre"), U.addNodeFilter("pre", function(e) {
            ...
            function _() {
                a.on("keydown", function(t) {
                    var n, r, i, o, s, l, u, d;
                    if (n = t.keyCode == F, !c(t) && (n || t.keyCode == I) && !e.modifierPressed(t) && (r = z.getRng(), i = r.startContainer, o = r.startOffset, u = r.collapsed, 3 == i.nodeType && i.nodeValue.length > 0 && (0 === o && !u || u && o === (n ? 0 : 1)))) {
                        if (l = i.previousSibling, l && "IMG" == l.nodeName)
                            return;
                        d = a.schema.getNonEmptyElements(), t.preventDefault(), s = W.create("br", {id: "__tmp"}), i.parentNode.insertBefore(s, i), a.getDoc().execCommand(n ? "ForwardDelete" : "Delete", !1, null), i = z.getRng().startContainer, l = i.previousSibling, l && 1 == l.nodeType && !W.isBlock(l) && W.isEmpty(l) && !d[l.nodeName.toLowerCase()] && W.remove(l), W.remove("__tmp")
                    }
                })
            }
            function N() {
                a.on("keydown", function(t) {
                    var n, r, i, o, s;
                    if (!c(t) && t.keyCode == e.BACKSPACE && (n = z.getRng(), r = n.startContainer, i = n.startOffset, o = W.getRoot(), s = r, n.collapsed && 0 === i)) {
                        for (; s && s.parentNode && s.parentNode.firstChild == s && s.parentNode != o; )
                            s = s.parentNode;
                        "BLOCKQUOTE" === s.tagName && (a.formatter.toggle("blockquote", null, s), n = W.createRng(), n.setStart(r, 0), n.setEnd(r, 0), z.setRng(n))
                    }
                })
            }
            function E() {
            ...
            function R() {
                a.on("keydown", function(e) {
                    var t;
                    c(e) || e.keyCode != I || (t = a.getDoc().selection.createRange(), t && t.item && (e.preventDefault(), a.undoManager.beforeChange(), W.remove(t.item(0)), a.undoManager.add()))
                })
            }
            function A() {
                var e;
            ...
            function H() {
                a.on("keyup focusin", function(t) {
                    65 == t.keyCode && e.metaKeyPressed(t) || z.normalize()
                })
            }
            function L() {
            ...
            function P() {
                a.inline || (a.contentStyles.push("body {min-height: 150px}"), a.on("click", function(e) {
                    "HTML" == e.target.nodeName && (a.execCommand("SelectAll"), a.selection.collapse(!0))
                }))
            }
            var O = o.each, I = e.BACKSPACE, F = e.DELETE, W = a.dom, z = a.selection, V = a.settings, U = a.parser, q = a.serializer, j = i.gecko, $ = i.ie, K = i.webkit;
            C(), N(), d(), H(), K && (_(), u(), p(), g(), S(), i.iOS ? (y(), M()) : f()), $ && i.ie < 11 && (h(), b(), x(), w(), R(), A(), B(), D()), i.ie >= 11 && P(), j && (h(), m(), v(), E(), k(), T(), L())
        }
    }), r(nt, [p], function(e) {
        function t() {
            return!1
    ...
    }), r(it, [v, b, C, k, E, A, D, H, L, M, P, O, y, l, et, x, _, tt, g, p, nt, rt], function(e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w) {
        function _(e, t) {
        ...
        var E = e.DOM, k = n.ThemeManager, S = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, D = C.trim, H = C.resolve, L = h.Event, M = b.gecko, P = b.ie, O = b.opera;
        return N.prototype = {render: function() {
                    ...
                    C.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")), R(r.external_plugins, function(e, t) {
                        ...
                        if (e = D(e), e && !S.urls[e])
                            if ("-" == e.charAt(0)) {
                                ...
                                S.load(e, {prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js"})
                ...
                if (!L.domLoaded)
                    return E.bind(window, "ready", e), void 0;
                if (n.getElement() && b.contentEditable) {
                    ...
                    a && (n.formElement = a, r.hidden_input && !/TEXTAREA|INPUT/i.test(n.getElement().nodeName) && E.insertAfter(E.create("input", {type: "hidden", name: i}), i), n.formEventDelegate = function(e) {
                        n.fire(e.type, e)
                ...
                e || (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || (b.opera || n.getBody().focus(), n.getWin().focus()), (M || i) && (l = n.getBody(), l.setActive ? l.setActive() : l.focus(), i && r.normalize()), a && a.ownerDocument == s && (o = s.body.createControlRange(), o.addElement(a), o.select())), n.editorManager.activeEditor != n && ((t = n.editorManager.activeEditor) && t.fire("deactivate", {relatedTarget: n}), n.fire("activate", {relatedTarget: t})), n.editorManager.activeEditor = n
            }, execCallback: function(e) {
                var t = this, n = t.settings[e], r;
                if (n)
                    return t.callbackLookup && (r = t.callbackLookup[e]) && (n = r.func, r = r.scope), "string" == typeof n && (r = n.replace(/\.\w+$/, ""), r = r ? H(r) : 0, n = H(n), t.callbackLookup = t.callbackLookup || {}, t.callbackLookup[e] = {func: n, scope: r}), n.apply(r || t, Array.prototype.slice.call(arguments, 1))
                ...
                e.removed || (e.removed = 1, P && n && n.execCommand("SelectAll"), e.save(), E.setStyle(e.id, "display", e.orgDisplay), e.settings.content_editable || (L.unbind(e.getWin()), L.unbind(e.getDoc())), L.unbind(e.getBody()), L.unbind(t), e.fire("remove"), e.editorManager.remove(e), E.remove(t), e.destroy())
        ...
        var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, h, m = {majorVersion: "4", minorVersion: "0.6", releaseDate: "2013-09-12", editors: [], i18n: s, activeEditor: null, setup: function() {
                var e = this, t, n, i = "", o;
                ...
                function o() {
                    var h, m;
                    if (c.unbind(window, "ready", o), r(t, "onpageload"), t.types)
                ...
                var t = this, n, r = t.editors, i, o;
                {
                    if (e) {
                        ...
                        return t.activeEditor == i && (t.activeEditor = r[0]), o && t.fire("RemoveEditor", {editor: i}), r.length || c.unbind(window, "beforeunload", h), i.remove(), i
                    }
        ...
        return e.extend({recalc: function(e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [], y, b, C, x, w, _, N, E, k, S, T, R, A, B, D, H, L, M, P, O, I, F, W, z, V = Math.max, U = Math.min;
                ...
                if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[W], x[D] = i[R] - d, x[z] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    ...
                    for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l?w = d + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[H] = o[I], t = 0, n = r.length; n > t; t++)
                        p = r[t], h = p.layoutRect(), y = h.maxFlexSize || h[E], "center" === s ? x[H] = Math.round(i[L] / 2 - h[M] / 2) : "stretch" === s ? (x[M] = V(h[P] || 0, i[L] - o[I] - o[F]), x[H] = o[I]) : "end" === s && (x[H] = i[L] - h[M] - o.top), h.flex > 0 && (y += Math.ceil(h.flex * C)), x[N] = y, x[k] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
    ...
    }), r(Lt, [V, yt, X, p, st, g], function(e, t, n, r, i, o) {
        function a(e) {
            function t(t) {
                function n(e) {
        ...
        return e.extend({Defaults: {border: 0, role: "menuitem"}, init: function(e) {
                ...
                var e = this, t = e._id, n = e.settings, r = e.classPrefix, i = e.encode(e._text), o = e.settings.icon, a = "";
                return o && e.parent().addClass("menu-has-icons"), n.image && (o = "none", a = " style=\"background-image: url('" + n.image + "')\""), o = r + "ico " + r + "i-" + (e.settings.icon || "none"), '<div id="' + t + '" class="' + e.classes() + '" tabindex="-1">' + ("-" !== i ? '<i class="' + o + '"' + a + "></i>&nbsp;" : "") + ("-" !== i ? '<span id="' + t + '-text" class="' + r + 'text">' + i + "</span>" : "") + (n.shortcut ? '<div id="' + t + '-shortcut" class="' + r + 'menu-shortcut">' + n.shortcut + "</div>" : "") + (n.menu ? '<div class="' + r + 'caret"></div>' : "") + "</div>"
            }, postRender: function() {
    ...
    }), a([l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, D, H, L, M, P, O, I, F, W, z, V, U, q, j, $, K, G, Y, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, kt, St, Tt, Rt, At, Bt, Dt, Ht, Lt, Mt, Pt, Ot, It, Ft, Wt, zt, Vt, Ut, qt, jt, $t, Kt, Gt, Yt, Xt, Jt])
}(this);